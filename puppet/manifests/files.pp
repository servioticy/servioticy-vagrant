...
file { '/opt/servioticy-dispatcher/dispatcher-0.4.2-security-SNAPSHOT-jar-with-dependencies.jar':
          ensure => present,
          source => "/usr/src/servioticy/servioticy-dispatcher/target/dispatcher-0.4.2-security-SNAPSHOT-jar-with-dependencies.jar",
