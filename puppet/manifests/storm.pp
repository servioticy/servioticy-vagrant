...
exec { "run_storm":
    command => "storm jar /opt/servioticy-dispatcher/dispatcher-0.4.0-jar-with-dependencies.jar com.servioticy.dispatcher.DispatcherTopology -f /opt/servioticy-dispatcher/dispatcher.xml &",
    cwd     => "/opt/apache-storm-0.9.2-incubating/bin",
    require => [Exec['run_kestrel'], File['/opt/servioticy-dispatcher/dispatcher-0.4.0-jar-with-dependencies.jar'], File['/opt/servioticy-dispatcher/dispatcher.xml']],
    user    => 'vagrant',
    group    => 'vagrant',
